...
function startPID_Callback(hObject, eventdata, handles)
% hObject    handle to startPID (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of startPID
handles.mainMain.UserData.MWC.PIDcontrolVelocity;
...
function velocityTolerance_Callback(hObject, eventdata, handles)
% hObject    handle to velocityTolerance (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of velocityTolerance as text
%        str2double(get(hObject,'String')) returns contents of velocityTolerance as a double
numberstr =  regexp(hObject.String,'((\d+)?(\.\d+)?)','tokens');
handles.mainMain.UserData.MWC.velocityTargetTolerance = str2double(numberstr{1}{1});
